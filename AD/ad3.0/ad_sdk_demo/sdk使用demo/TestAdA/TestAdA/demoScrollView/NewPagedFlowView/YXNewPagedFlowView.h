...
@protocol YXNewPagedFlowViewDataSource;
@protocol YXNewPagedFlowViewDelegate;
...
} YXNewPagedFlowViewOrientation;

@interface YXNewPagedFlowView : UIView<UIScrollViewDelegate>
...
@property (nonatomic, assign) id <YXNewPagedFlowViewDataSource> dataSource;
@property (nonatomic, assign) id <YXNewPagedFlowViewDelegate>   delegate;
...
@protocol  YXNewPagedFlowViewDelegate<NSObject>
...
@protocol YXNewPagedFlowViewDataSource <NSObject>
