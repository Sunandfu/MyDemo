...
@interface YXMutBannerAdManager()<YXNewPagedFlowViewDelegate, YXNewPagedFlowViewDataSource>
{
    NSArray *adArr;
...
- (YXPGIndexBannerSubiew *)flowView:(YXNewPagedFlowView *)flowView cellForPageAtIndex:(NSInteger)index{
    ...
    if (_resultDict) {
        ...
        [NetTool setImage:bannerView.mainImageView WithURL:[NSURL URLWithString:imgUrl] placeholderImage:nil];
