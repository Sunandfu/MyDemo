...
@interface YXInterstitialAdManager ()<GDTMobInterstitialDelegate,UIWebViewDelegate,UIGestureRecognizerDelegate,YXWebViewDelegate>
{
    CGFloat _width;
    CGFloat _height;
}
...
- (void)tapImg:(UITapGestureRecognizer *)recognizer
{
    ...
    if ([ac_type isEqualToString:@"1"] || [ac_type isEqualToString:@"2"]) {
        ...
        NSString *deeplick = self.resultDict[@"deep_url"];
