...
//xmlc_ios_vehicle_banner 694 148
//xmlc_ios_top_banner     670 240
//xmlc_ios_bonus_banner   670 240
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([model isKindOfClass:[YXFeedAdData class]]) {
//      点击  和  点击上报 处理
        YXFeedAdData *data = (YXFeedAdData *)model;
        NSLog(@"跳转地址%@",data.clickedUrl);
    }
}
