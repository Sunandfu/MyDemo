...
@class YXFLAnimatedImage;
@protocol YXFLAnimatedImageViewDebugDelegate;


//
//  An `YXFLAnimatedImageView` can take an `YXFLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface YXFLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) YXFLAnimatedImage *animatedImage;
