...
- (void)viewDidLoad {
    ...
    UIButton *iconBtn = ({
        ...
        [button setTitle:@"RefreshNewsTest" forState:UIControlStateNormal];
        [button addTarget:self action:@selector(refreshBtnClicked) forControlEvents:UIControlEventTouchUpInside];
        button;
    });
