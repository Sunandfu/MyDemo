...
@interface FeedMessageTableViewCellTwo()
...
@implementation FeedMessageTableViewCellTwo
...
- (void)awakeFromNib {
    ...
    self.imageViewOne.image = self.imageViewTwo.image = self.imageViewThree.image = [UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"];
}
...
//            [NetTool setImage:self.imageViewTwo WithURLStr:imgStr placeholderImage:[UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"]];
            ...
            [self.imageViewThree sd_setImageWithURL:[NSURL URLWithString:imgStr] placeholderImage:[UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"]];
//            [NetTool setImage:self.imageViewThree WithURLStr:imgStr placeholderImage:[UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"]];
        }
    }
    ...
    self.imageViewOne.layer.masksToBounds = self.imageViewTwo.layer.masksToBounds = self.imageViewThree.layer.masksToBounds = YES;
    self.imageViewOne.layer.cornerRadius = self.imageViewTwo.layer.cornerRadius = self.imageViewThree.layer.cornerRadius = [SFNewsConfiguration defaultConfiguration].cornerRadius;
