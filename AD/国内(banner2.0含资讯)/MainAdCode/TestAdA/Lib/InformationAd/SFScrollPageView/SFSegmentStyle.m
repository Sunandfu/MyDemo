...
@implementation SFSegmentStyle

- (instancetype)init {
    if(self = [super init]) {
        _showCover = NO;
        _showLine = NO;
        _showDemarcationLine = NO;
        _scaleTitle = NO;
        _scrollTitle = YES;
        ...
        _scrollDemarcationLineColor = [UIColor lightGrayColor];
        ...
        _titleBigScale = 1.3;
        _normalTitleColor = [UIColor colorWithRed:60/255.0 green:65/255.0 blue:70/255.0 alpha:1.0];
