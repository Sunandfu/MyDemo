...
typedef enum : NSUInteger {
    YXAnimationPageControlNoamal,                          //正常状态下动画
    YXAnimationPageControlRotation,                        //旋转动画
    YXAnimationPageControlJump,                            //跳跃旋转动画
} YXAnimationPageControlType;

@interface YXAnimationPageControl : UIView
...
/**
 animationType 动画类型
 */
@property (nonatomic, assign) YXAnimationPageControlType  animationType;
...
/**
 ...
 @return YXAnimationPageControl 的实例
 */
