...
#import "YXHorizontalPageControl.h"
#import "YXLaunchConfiguration.h"

@class YXBannerScrollView;

@protocol YXBannerScrollViewDelegate <NSObject>
...
- (Class)customCollectionViewCellClassForCycleScrollView:(YXBannerScrollView *)view;
...
@interface YXBannerScrollView : UIView
...
@property (nonatomic, weak) id<YXBannerScrollViewDelegate> delegate;
