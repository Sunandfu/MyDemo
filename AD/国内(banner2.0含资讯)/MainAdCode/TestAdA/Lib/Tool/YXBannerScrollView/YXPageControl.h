...
@protocol YXPageControlDelegate;
 ...
 */
@property(nonatomic,assign) id<YXPageControlDelegate> delegate;
...
@protocol YXPageControlDelegate <NSObject>

@optional

- (void)YXPageControl:(YXPageControl *)pageControl didSelectPageAtIndex:(NSInteger)index;
