...
@interface NSObject (addFunction)<SFWebViewDelegate,YXWebViewDelegate>

@end

@implementation NSObject (addFunction)
...
- (void)customWebViewClicked{
    [[NSNotificationCenter defaultCenter] postNotificationName:WEBCUSTOMCLICKNOTIFITION object:nil];
}
