...
- (void)layoutSubviews {
    ...
    self.iconImageView.frame = CGRectMake(5, 5, self.frame.size.width-10, self.frame.size.width-10);
    self.titleLabel.frame = CGRectMake(5, self.frame.size.width-5, self.frame.size.width-10, self.frame.size.height-self.frame.size.width);
