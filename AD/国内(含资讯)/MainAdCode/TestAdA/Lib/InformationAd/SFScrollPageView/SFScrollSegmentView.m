...
- (void)addScrollLineOrCoverOrExtraBtn {
    ...
    if (self.segmentStyle.isShowDemarcationLine) {
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-1, self.bounds.size.width, 0.7)];
        lineView.backgroundColor = self.segmentStyle.scrollDemarcationLineColor;
...
- (UIScrollView *)scrollView {
    ...
    if (!_scrollView) {
        ...
        scrollView.backgroundColor = self.segmentStyle.backGroundColor;
