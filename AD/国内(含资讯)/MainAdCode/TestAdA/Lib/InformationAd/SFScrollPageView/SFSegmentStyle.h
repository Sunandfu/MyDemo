...
@interface SFSegmentStyle : NSObject
...
/** 是否显示分割线条 默认为NO*/
@property (assign, nonatomic, getter=isShowDemarcationLine) BOOL showDemarcationLine;
/** 是否显示图片 默认为NO*/
...
/** segmentVIew的高度, 这个属性只在使用SFScrollPageVIew的时候设置生效 */
