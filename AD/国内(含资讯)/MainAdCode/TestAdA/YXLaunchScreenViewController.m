...
- (void)launchScreenBtnClicked:(UIButton*)sender
{
    ...
    adManager.waitDataDuration = 2;
    adManager.duration = 8;
    adManager.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
    ...
    adManager.showFinishAnimateTime = 0.0;
