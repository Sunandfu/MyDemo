...
//        self.imageViewOne.image = [UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"];
        ...
        [self.contentLabel setAttributedText:[NetTool attributedSetWithString:content]];
        self.fromLabel.text = model.buttonText?model.buttonText:@"查看详情";
        self.timeLabel.text = @"广告";
        [self.imageViewOne sd_setImageWithURL:[NSURL URLWithString:model.imageUrl] placeholderImage:[UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"]];
    }
//    [NetTool setImage:self.imageViewOne WithURLStr:model.imageUrl placeholderImage:[UIImage imageNamed:@"XibAndPng.bundle/sf_placeImg"]];
