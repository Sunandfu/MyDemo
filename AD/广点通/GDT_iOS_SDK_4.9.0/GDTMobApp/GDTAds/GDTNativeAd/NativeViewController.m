...
- (IBAction)loadAd:(id)sender {
     ...
     * 这里详情图以1280*720为例
     */
    NSString *placementId = self.posTextField.text.length > 0? self.posTextField.text: self.posTextField.placeholder;
    self.nativeAd = [[GDTNativeAd alloc] initWithAppId:kGDTMobSDKAppId placementId:placementId];
