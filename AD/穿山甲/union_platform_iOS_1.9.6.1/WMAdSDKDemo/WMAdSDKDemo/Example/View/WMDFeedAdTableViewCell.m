...
@implementation WMDFeedAdBaseTableViewCell
...
- (void)buildupView {
    ...
    self.nativeAdRelatedView = [[WMNativeAdRelatedView alloc] init];
}
...
- (void)refreshUIWithModel:(WMNativeAd *)model {
    self.nativeAd = model;
...
@implementation WMDFeedAdLeftTableViewCell
...
- (void)refreshUIWithModel:(WMNativeAd *_Nonnull)model {
    ...
    WMImage *image = model.data.imageAry.firstObject;
    ...
    NSAttributedString *attributedText = [WMDFeedStyleHelper titleAttributeText:model.data.AdTitle];
    ...
    self.adDescriptionLabel.attributedText = [WMDFeedStyleHelper subtitleAttributeText:model.data.AdDescription];
}
...
@implementation WMDFeedAdLargeTableViewCell
...
@implementation WMDFeedAdGroupTableViewCell
...
- (void)buildupView {
    ...
    self.actionView = [WMDActionAreaView new];
...
- (void)refreshUIWithModel:(WMNativeAd *)model {
    ...
    WMImage *image = model.data.imageAry[0];
    const CGFloat imageHeight = imageWidth * (image.height / image.width);
    ...
    // action
    if (model.data.interactionType == WMInteractionTypeDownload) {
...
// 视频广告 cell
@interface WMDFeedVideoAdTableViewCell ()

@end

@implementation WMDFeedVideoAdTableViewCell
