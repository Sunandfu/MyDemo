...
@interface WMDFullscreenViewController () <WMFullscreenVideoAdDelegate>

@property (nonatomic, strong) WMFullscreenVideoAd *fullscreenVideoAd;
@property (nonatomic, strong) UIButton *button;

@end

@implementation WMDFullscreenViewController
