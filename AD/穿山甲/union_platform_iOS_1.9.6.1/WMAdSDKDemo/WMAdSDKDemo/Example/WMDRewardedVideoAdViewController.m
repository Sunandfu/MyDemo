//
//  WMDRewardedVideoAdViewController.m
//  WMDemo
//
...
@interface WMDRewardedVideoAdViewController () <WMRewardedVideoAdDelegate>
...
@implementation WMDRewardedVideoAdViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self buildupView];
#warning 每次请求数据 需要重新创建一个对应的 WMRewardedVideoAd管理,不可使用同一条重复请求数据.
