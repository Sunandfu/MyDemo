...
#import "WMDRewardCustomEventAdapter.h"
#import "WMDRewardCustomEventAdapterDelegate.h"
#import <WMAdSDK/WMRewardedVideoModel.h>
#import <WMAdSDK/WMRewardedVideoAd.h>

@interface WMDRewardCustomEventAdapter ()
{
    __weak id<GADMRewardBasedVideoAdNetworkConnector> _rewardBasedVideoAdConnector;
    WMDRewardCustomEventAdapterDelegate *_adapterDelegate;
}
@property (nonatomic, strong) WMRewardedVideoAd *rewardedVideoAd;

@end

@implementation WMDRewardCustomEventAdapter
...
- (instancetype)initWithRewardBasedVideoAdNetworkConnector:(id<GADMRewardBasedVideoAdNetworkConnector>)connector {
    ...
    if (self) {
        ...
        _adapterDelegate = [[WMDRewardCustomEventAdapterDelegate alloc] initWithRewardBasedVideoAdAdapter:self rewardBasedVideoAdconnector:_rewardBasedVideoAdConnector];
    }
    return self;
}
...
- (void)setUp {
    ...
    ///配置slotId
    self.rewardedVideoAd = [[WMRewardedVideoAd alloc] initWithSlotID:@"900546748" rewardedVideoModel:model];
