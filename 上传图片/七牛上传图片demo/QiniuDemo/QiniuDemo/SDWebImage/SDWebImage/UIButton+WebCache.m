...
- (void)sd_setImageWithURL:(NSURL *)url forState:(UIControlState)state {
    UIImage *defaultPlaceholder = [UIImage imageNamed:@"my_info_user_icon_default.png"];

    [self sd_setImageWithURL:url forState:state placeholderImage:defaultPlaceholder options:0 completed:nil];
}
...
- (void)sd_setBackgroundImageWithURL:(NSURL *)url forState:(UIControlState)state {
    ...
    UIImage *placeholder = [UIImage imageNamed:@"default_bg_z"];
