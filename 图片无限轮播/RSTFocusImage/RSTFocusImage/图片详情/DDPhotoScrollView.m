...
- (instancetype)initWithFrame:(CGRect)frame urlString:(NSString *)urlString
{
	...
	if (self) {
        ...
        // 单击手势
        UILongPressGestureRecognizer *longPress = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longTapOnScrollView)];
