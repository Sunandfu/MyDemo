...
typedef enum : NSUInteger {
    SFAnimationPageControlNoamal,                          //正常状态下动画
    SFAnimationPageControlRotation,                        //旋转动画
    SFAnimationPageControlJump,                            //跳跃旋转动画
} SFAnimationPageControlType;

@interface SFAnimationPageControl : UIView
...
/**
 animationType 动画类型
 */
@property (nonatomic, assign) SFAnimationPageControlType  animationType;
...
/**
 ...
 @return SFAnimationPageControl 的实例
 */
