...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _pageControlStyle = SFBannerScrollViewPageContolStyleClassic;
        _pageControlAliment = SFBannerScrollViewPageContolAlimentCenter;
...
//        size = CGSizeMake(self.viewArray.count * self.pageControlDotSize.width, self.pageControlDotSize.height);
    ...
    if (self.pageControlAliment == SFBannerScrollViewPageContolAlimentRight) {
        x = self.frame.size.width - size.width - 10;
    } else if(self.pageControlAliment == SFBannerScrollViewPageContolAlimentLeft) {
        x = 20;
    }
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(loopFocusWithIndex:)]) {
        [_delegate loopFocusWithIndex:self.currIndex];
    }
}
...
- (void)setPageControlStyle:(SFBannerScrollViewPageContolStyle)pageControlStyle {
...
- (void)setupPageControl {
    ...
    switch (self.pageControlStyle) {
        case SFBannerScrollViewPageContolStyleAnimated: {
            ...
            break;
        case SFBannerScrollViewPageContolStyleClassic: {
            ...
            break;
        case SFBannerScrollViewPageControlHorizontal: {
            ...
            break;
        case SFBannerScrollViewPageImageRotation: {
            ...
            break;
        case SFBannerScrollViewPageImageJump: {
            SFAnimationPageControl *pageControl = [[SFAnimationPageControl alloc] init];
            pageControl.pages = self.viewArray.count;
            pageControl.normalPageImage = self.pageDotImage;
            ...
            break;
        case SFBannerScrollViewPageImageAnimated: {
            SFAnimationPageControl *pageControl = [[SFAnimationPageControl alloc] init];
            pageControl.pages = self.viewArray.count;
            pageControl.normalPageImage = self.pageDotImage;
            ...
            break;
        case SFBannerScrollViewPageContolStyleNone: {}
            break;
        default:
            break;
    }
