...
@interface SFAbstractDotView : UIView
...
@interface SFAnimatedDotView : SFAbstractDotView

@property (nonatomic, strong) UIColor *dotColor;

@end

@interface SFDotView : SFAbstractDotView
...
/**
 * 你的自定义 UIView 的类，确保尊重 TAAbstractDotView 类。
 */
