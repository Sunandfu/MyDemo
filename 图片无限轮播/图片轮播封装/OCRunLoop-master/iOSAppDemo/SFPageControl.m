...
@implementation SFAbstractDotView
...
@implementation SFAnimatedDotView
 ...
 */
- (void)initialization {
    self.dotViewClass           = [SFAnimatedDotView class];
...
- (UIView *)generateDotView {
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[SFAnimatedDotView class]] && self.dotColor) {
            ((SFAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
- (void)changeActivity:(BOOL)active atIndex:(NSInteger)index {
    if (self.dotViewClass) {
        SFAbstractDotView *abstractDotView = (SFAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [SFAbstractDotView class]);
        }
