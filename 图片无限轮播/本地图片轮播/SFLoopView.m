...
- (void)addPageControl {
    ...
    pageControl.currentPageIndicatorTintColor = HBlueColor;
...
- (void)addScrollView {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:self.currentImages[i%self.images.count]] placeholderImage:[UIImage imageNamed:self.currentImages[i]]];
...
- (void)refreshImages {
    ...
    for (int i = 0; i < subViews.count; i++) {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:self.currentImages[i]] placeholderImage:[UIImage imageNamed:self.currentImages[i]]];
        imageView.contentMode = UIViewContentModeScaleAspectFill;
    }
