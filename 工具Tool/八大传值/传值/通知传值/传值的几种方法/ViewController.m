...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserverForName:@"ZQSendMessage" object:nil queue:nil usingBlock:^(NSNotification * _Nonnull note) {
        NSArray *array=[[NSArray alloc]initWithArray:note.object];
