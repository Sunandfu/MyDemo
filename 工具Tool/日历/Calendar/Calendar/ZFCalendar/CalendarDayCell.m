...
- (void)setModel:(CalendarDayModel *)model
{
    ...
    if(model.style==CellDayTypeEmpty)//不显示
    {
        [self hidden_YES];

        return;
    }
    else if (model.style==CellDayTypePast)//过去的日期
    {
        [self hidden_NO];
        if (model.holiday) {
        ...
        if (model.Chinese_holiday) {
            day_title.text = model.Chinese_holiday;
        }else{
    ...
    else if (model.style==CellDayTypeFutur)//将来的日期
    {
        [self hidden_NO];
        ...
        if (model.Chinese_holiday) {
            day_title.text = model.Chinese_holiday;
            day_title.textColor = [UIColor purpleColor];
        }else{
            day_title.text = model.Chinese_calendar;
            day_title.textColor = [UIColor lightGrayColor];
        }
    ...
    else if(model.style==CellDayTypeWeek)//周末
    {
        [self hidden_NO];
    ...
    else if(model.style==CellDayTypeClick)//被点击的日期
    {
        [self hidden_NO];
