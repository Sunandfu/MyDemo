...
- (void)setUp
{
    ...
    _samllCircleView.layer.masksToBounds = YES;
...
- (void)startDestroyAnimations
{
    ...
    self.animImageView = ainmImageView;
    [self performSelector:@selector(cleanAnimImageView) withObject:nil afterDelay:0.5];
}
