...
static NSString *HxRingStrokeAnimationKey = @"mmmaterialdesignspinner.stroke";
static NSString *HxRingRotationAnimationKey = @"mmmaterialdesignspinner.rotation";
...
- (void)startAnimating {
    ...
    [self.progressLayer addAnimation:animation forKey:@"mmmaterialdesignspinner.rotation"];
    ...
    [self.progressLayer addAnimation:animations forKey: HxRingStrokeAnimationKey];
