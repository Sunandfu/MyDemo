...
@interface ESInputJsonController ()<NSTextViewDelegate,NSTableViewDataSource,NSTableViewDelegate,NSTabViewDelegate,NSTextFieldDelegate,NSTextDelegate>
...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        ...
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"isSFModel"];
        self.rowCount = 1;
        self.selectedRow = -1;
...
- (IBAction)selectedModelTypeSegmentControllerAction:(NSSegmentedControl *)sender {
    ...
    BOOL isSFModel = (sender.selectedSegment == 1)?YES:NO;
    [[NSUserDefaults standardUserDefaults] setBool:isSFModel forKey:@"isSFModel"];
