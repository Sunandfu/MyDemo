...
@class SFAnimatedImage;
@protocol SFAnimatedImageViewDebugDelegate;


//
//  An `SFAnimatedImageView` can take an `SFAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface SFAnimatedImageView : UIImageView
...
@property (nonatomic, strong) SFAnimatedImage *animatedImage;
