...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.subTitleMenus.count>0) {
        cell.detailTextLabel.text = self.subTitleMenus[indexPath.row];
    }
    if (self.imageMenus.count>0) {
        cell.imageView.image = [UIImage imageNamed:self.subTitleMenus[indexPath.row]];
    }
    return cell;
}
