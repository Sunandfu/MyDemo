...
- (MMTableViewCellInfo *)createOpenBlockSendInputStatusCell{
    ...
    return [objc_getClass("MMTableViewCellInfo") switchCellForSel:@selector(openBlockSendInputStatusSwitchHandler:) target:self title:@"阻止发送正在输入状态" on:openBlockSendInputStatus];
}
