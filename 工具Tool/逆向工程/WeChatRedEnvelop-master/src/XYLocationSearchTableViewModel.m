...
- (void)fetchNearbyInfoCompletionHandler:(void (^)(NSArray<MKMapItem *> *, NSError *))completionHandle {
    [self fetchNearbyInfoWithCoordinate:CLLocationCoordinate2DMake([WBRedEnvelopConfig sharedConfig].latitude, [WBRedEnvelopConfig sharedConfig].longitude) completionHandler:completionHandle];
}
