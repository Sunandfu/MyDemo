...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIApplicationShortcutItem *item = [[UIApplicationShortcutItem alloc] initWithType:@"shortcutTypeOne" localizedTitle:@"崩溃列表" localizedSubtitle:@"快看谁测试崩了" icon:icon userInfo:nil];
...
//    UINavigationController *nav = (UINavigationController *)self.window.rootViewController;
    ListTableViewController *detailVC = [[ListTableViewController alloc] init];
