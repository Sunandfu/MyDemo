...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *MacStr = [[self.rqlistarry objectAtIndex:row] substringToIndex:17];
    iphoneMacTitletext.text = [MacStr uppercaseString];
    ...
    NSString *IPStr = [[self.rqlistarry objectAtIndex:row] substringFromIndex:17];
    iphoneIpTitletext.text = [IPStr uppercaseString];
