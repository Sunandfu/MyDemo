...
- (instancetype)init {
    self = [super init];
    if (self != nil) {
        self.window = [[NSWindow alloc] initWithContentRect:NSMakeRect(0, 0,668 , 452) styleMask:NSWindowStyleMaskTitled | NSWindowStyleMaskClosable backing:NSBackingStoreBuffered defer:NO];
