...
- (void)storageDictionary:(NSDictionary *)dictionary forKey:(NSString *)dictionaryKey{
    ...
    [_userDefaults setObject:data forKey:dictionaryKey];
}

- (NSDictionary *)fetchStorageDictionaryForKey:(NSString *)dictionaryKey{
    
    NSDictionary *dictionary = [NSKeyedUnarchiver unarchiveObjectWithData:[_userDefaults objectForKey:dictionaryKey]];
