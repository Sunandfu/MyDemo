...
{
    if (!_arrowImage) {
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"arrow_up"]];
...
//        [self addSubview:_activityView = activityView];
        ...
        UIImageView *animation = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
        animation.center = _arrowImage.center;
        animation.animationDuration = 1.0;
        animation.autoresizingMask = UIViewAutoresizingNone;
        animation.animationImages = @[[UIImage imageNamed:@"refresh1"],[UIImage imageNamed:@"refresh2"],[UIImage imageNamed:@"refresh3"],[UIImage imageNamed:@"refresh4"],[UIImage imageNamed:@"refresh5"],[UIImage imageNamed:@"refresh6"],[UIImage imageNamed:@"refresh7"],[UIImage imageNamed:@"refresh8"],[UIImage imageNamed:@"refresh9"]];
        
        [self addSubview:_activityView = animation];
    }
