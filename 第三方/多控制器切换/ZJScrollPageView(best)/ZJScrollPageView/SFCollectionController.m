...
@interface SFCollectionController ()<UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, strong)UICollectionView *collectionView;
@end

@implementation SFCollectionController


static NSString *cellId = @"cellId";


// SFScrollPageViewChildVcDelegate 这个代理方法用于页面出现的时候处理
...
- (void)viewDidLoad {
    ...
    // 这个设置上面的内容偏移量为SFVc9Controller里面定义的常量defaultOffSetY
