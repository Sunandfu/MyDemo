...
//        NSArray *vcs = [NSArray arrayWithObject:self.viewControllers[2]];
        ...
        NSArray *vcs;
        if (_pageVC.spineLocation == UIPageViewControllerSpineLocationMid) {
            vcs = [NSArray arrayWithObjects:self.viewControllers[0], self.viewControllers[1], nil];
        } else {
            vcs = [NSArray arrayWithObjects:self.viewControllers[0], nil];
        }
