...
class ViewController: UIViewController ,GameViewDelegate {
    ...
    func addButtons()
    {
        ...
        leftBtn.addTarget(self, action: #selector(ViewController.left(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        upBtn.addTarget(self, action: #selector(ViewController.up(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        rightBtn.addTarget(self, action: #selector(ViewController.right(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        downBtn.addTarget(self, action: #selector(ViewController.down(_:)), forControlEvents: UIControlEvents.TouchUpInside)
