...
#import "WSAnimationSevice.h"


@interface WSDownloadView ()
{
    id _target;
    SEL _action;
    BOOL isAnimating;
...
@property (nonatomic, strong) WSAnimationSevice *service;

@end

@implementation WSDownloadView
...
- (void)initialize{
    ...
    self.service = [[WSAnimationSevice alloc] init];
