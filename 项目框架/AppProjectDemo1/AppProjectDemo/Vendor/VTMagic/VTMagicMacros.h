...
// 状态栏高度
#define VTSTATUSBAR_HEIGHT ([[UIApplication sharedApplication] statusBarFrame].size.height)==40?20:([[UIApplication sharedApplication] statusBarFrame].size.height)
