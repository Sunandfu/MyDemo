...
- (CGRect)getRect{
    return CGRectMake(kReadSpaceX, self.safeAreaInsets.top+kReadingTopH, SF_ScreenW - kReadSpaceX*2, SF_ScreenH - kReadingTopH - kReadingBottomH - self.safeAreaInsets.top - self.safeAreaInsets.bottom);
}
