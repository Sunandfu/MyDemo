...
//返回后刷新上一个页面的数据
@property (nonatomic,copy)returnRefreshBlock refreshBlock;
-(void)returnLastViewController:(returnRefreshBlock)block;


@property(nonatomic,retain)NSMutableArray *listTitleArry;
@property(nonatomic,retain)NSMutableArray *updateArry;
@property(nonatomic,retain)NSMutableArray *achieveArray;
...
- (InformationController *)p_defaultController;
@end